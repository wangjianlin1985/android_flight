...
public class UserInfoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (action.equals("query")) {
			...
			/*调用业务逻辑层执行用户查询*/
			List<UserInfo> userInfoList = userInfoDAO.QueryUserInfo(user_name,name,birthday,cityObj);
			...
			for (int i = 0; i < userInfoList.size(); i++) {
				...
				.append("		<cityObj>")
				.append(userInfoList.get(i).getCityObj())
			...
			try {
			  ...
			  stringer.key("cityObj").value(userInfo.getCityObj());
