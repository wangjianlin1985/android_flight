...
public class DotAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.dot_add); 
			...
			public void onClick(View v) {
				try {
					...
					if(ET_title.getText().toString().equals("")) {
						Toast.makeText(DotAddActivity.this, "网点名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(DotAddActivity.this, "电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_fax.getText().toString().equals("")) {
						Toast.makeText(DotAddActivity.this, "传真输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_address.getText().toString().equals("")) {
						Toast.makeText(DotAddActivity.this, "地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传网点信息*/
					DotAddActivity.this.setTitle("正在上传网点信息，稍等...");
					String result = dotService.AddDot(dot);
