...
public class CompanyListHandler extends DefaultHandler {
	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (company != null) { 
            ...
            else if ("personName".equals(tempString)) 
            	company.setPersonName(valueString); 
            else if ("telephone".equals(tempString)) 
            	company.setTelephone(valueString); 
            else if ("bornDate".equals(tempString)) 
            	company.setBornDate(Timestamp.valueOf(valueString));
        } 
	}
